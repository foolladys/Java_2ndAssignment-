...
<table border="1" style="margin : 0 auto">
 ...
 <c:forEach var="vote_rank_list" items="${vote_rank_list}">
  	<tr>
 		<td>${vote_rank_list.candidate_number}</td>
 		<td>${vote_rank_list.name}</td>
 		<td>${vote_rank_list.voted_count}</td>
 	</tr>
 </c:forEach>
  <tr>
 	<td colspan="3"><a href="VoteMainPage.jsp">메인 페이지로 돌아가기</a></td>
 </tr>
